...
public class MiPerfilFragment extends Fragment {
    ...
    Usuario usuario = MainActivity.usuario;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivFotoPerfil = (ImageView)view.findViewById(R.id.imageView_fotoperfil_perfil);
        tvNombrePerfil = (TextView) view.findViewById(R.id.textView_nombreperfil_perfil);
        rv = (RecyclerView) view.findViewById(R.id.recyclerView_publicaciones_miperfil);
        rv.setLayoutManager(new GridLayoutManager(view.getContext(), 3));

        listPublicaciones = new ArrayList<>();
        //llenarLista();

        //usuario.setListaPublicaciones(listPublicaciones);
        AdapterGridPublicaciones adapter =  new AdapterGridPublicaciones(MainActivity.usuario.getListaPublicaciones());
        rv.setAdapter(adapter);
        Glide.with(view.getContext()).load(usuario.getRutaFotoPerfil()).circleCrop().into(ivFotoPerfil);
        tvNombrePerfil.setText(usuario.getNombreUsuario());
